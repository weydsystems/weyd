...
<title>Animals & Pets -Category | Weyd</title>
...
<div class="col-sm-20 page-content col-thin-left">
  ...
  <a href="electronics-and-appliances.php"><h2 class="title-2"><img src="images/pets.png" style="color:#16A085; font-size:30px; width:40px;height:40px;">
  </h2></a>
...
<div class="category-list">
  ...
  <?php include("core/animal-and-pets-ads.php");?>
<!--- content -->
