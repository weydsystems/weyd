...
<button class="btn btn-primary btn-search btn-block"><i class="icon-mail-1"></i><strong>
...
<h2><a href="blog-details.php">Donec leo lorem, suscipit vitae eros et,
...
<div class="col-md-6"><input class="form-control" type="text" placeholder="Enter your name" aria-required="true" value="" name="author"></div>
<div class="col-md-6 text-left"><span>Name*</span></div>
</div>
<div class="row form-group">
<div class="col-md-6"><input class="form-control" type="text" placeholder="Enter your email" aria-required="true" value="" name="email"></div>
<div class="col-md-6 text-left"><span>E-mail*</span></div>
</div>
<div class="row form-group">
<div class="col-md-6"><input class="form-control" type="text" value="" placeholder="Enter your website" name="url"></div>
...
<div class="add-image"><a href="ads-details.php"><img class="no-margin" src="images/blog/5.jpg" alt="img"></a>
</div>
</div>

<div class="col-sm-8 col-xs-8 add-desc-box">
<div class="add-details">
<h5 class="add-title"><a href="ads-details.php">Sed aliquam leo et
...
<div class="item-list">
<div class="col-sm-4 col-xs-4 no-padding photobox">
<div class="add-image"><a href="ads-details.php"><img class="no-margin" src="images/blog/7.jpg" alt="img"></a>
</div>
</div>

<div class="col-sm-8 col-xs-8 add-desc-box">
<div class="add-details">
<h5 class="add-title"><a href="ads-details.php">Maecenas vel
consequat metus perferendis sunt aliquam </a></h5>
<span class="info-row"> <span class="date"><i class=" icon-clock"> </i> Today 12:50 pm </span> </span>
</div>
</div>
...
<div class="item-list">
<div class="col-sm-4 col-xs-4 no-padding photobox">
<div class="add-image"><a href="ads-details.php"><img class="no-margin" src="images/blog/3.jpg" alt="img"></a>
</div>
</div>

<div class="col-sm-8 col-xs-8 add-desc-box">
<div class="add-details">
<h5 class="add-title"><a href="ads-details.php">Pellentesque
venenatis, arcu in aliquam ultricies</a></h5>
<span class="info-row"> <span class="date"><i class=" icon-clock"> </i> Today 12:10 pm </span> </span>
</div>
</div>
...
<div class="item-list">
<div class="col-sm-4 col-xs-4 no-padding photobox">
<div class="add-image"><a href="ads-details.php"><img class="no-margin" src="images/item/tp/Image00006.jpg" alt="img"></a>
</div>
</div>

<div class="col-sm-8 col-xs-8 add-desc-box">
<div class="add-details">
<h5 class="add-title"><a href="ads-details.php">Erat mauris tempus
purus consectetur adipiscing elit. </a></h5>
<span class="info-row"> <span class="date"><i class=" icon-clock"> </i> Today 10:30 am</span> </span>
</div>
</div>
...
<div class="add-image"><a href="ads-details.php"><img class="no-margin" src="images/blog/10.jpg" alt="img"></a>
</div>
</div>

<div class="col-sm-8 col-xs-8 add-desc-box">
<div class="add-details">
<h5 class="add-title"><a href="ads-details.php">Inventore ex
perferendis sunt aliquam </a></h5>
<span class="info-row"> <span class="date"><i class=" icon-clock"> </i> Today 9:20 am </span> </span>
</div>
</div>
...
<!-- Mirrored from templatecycle.com/demo/bootclassified-v1.6/dist/blog-details.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Apr 2017 18:25:07 GMT -->
</html>
